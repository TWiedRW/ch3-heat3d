...
# weather2023 <- read.csv('https://www.ncei.noaa.gov/orders/cdo/3832990.csv')
# write.csv(weather2023, 'weather2023.csv')

weather2023 <- read.csv('weather2023.csv')

ggplot(weather2023, aes(x = TMIN, y = TMAX)) + 
  geom_density_2d() + 
  theme(aspect.ratio = 1)
