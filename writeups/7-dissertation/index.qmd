...
kbl(digits = 2, caption = 'Demographic Information', booktabs = T, col.names = c('', 'Count', 'Proportion')) %>% 
  kable_paper() %>% 
...
```{r}
#| fig-height: 3
#| fig-cap: "Counts of response behavior for when values in the stimuli pair were the same."
