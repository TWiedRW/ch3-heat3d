...
```{r}
#| label: fig-heat2d-examp
#| fig-cap: "Example of a 2D heat map"
set.seed(231224)
expand_grid(
  x = 1:5,
  y = 1:5
...
While there are many methods of evaluating the qualities of a "good" chart [@vanderplas2020], we focus on the accuracy of numerical extractions from the chart. This is a common technique used in data visualization studies.
